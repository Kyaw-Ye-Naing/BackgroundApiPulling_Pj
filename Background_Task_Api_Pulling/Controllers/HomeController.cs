    ...
    public class HomeController : Controller
    {
        ...
        public IActionResult CalculateHomeHandicap()
        {
            ...
            var person = (from p in db.TblPreUpcomingEvent
                        ...
                        on p.RapidEventId equals e.RapidEventId
                          where e.HomeHandicap.Contains("-") && p.Active == true && p.EventTime.Value.Date == dt
                          select new
                          {
                              ID = p.RapidEventId,
            ...
            foreach (var s in person)
            {
                ...
                Console.WriteLine("Complete 1 result from   HOME ");
        ...
        public IActionResult CalculateAwayHandicap()
        {
            ...
            foreach (var s in person)
            {
                ...
                Console.WriteLine("Complete 1 result from   AWAY  ");
                ...
                foreach (var item in betting)
                {
                    ...
                    if (item.betType == 1)
                    {
                        ...
                        if (item.betOver == false && item.betUnder == false)
                        {
                            ...
                            if (tempOver == true)
                            {
                                if (item.betIsHome == true)
                                {
                                    //HomeGoal - AwayGoal
                                    diff = hgoal - agoal;
                                    totalAmount = bettingCal.WinOrLoseOver(goalUnitInt, diff, unit, item.betAmount, (decimal)commission);
                            ...
                            else
                            {
                                if (item.betIsHome == true)
                                {
                                    ...
                                    diff = agoal - hgoal;
                                    unit *= -1;
                                    totalAmount = bettingCal.WinOrLoseUnder(goalUnitInt, diff, unit, item.betAmount, (decimal)commission);
                                    Console.WriteLine(totalAmount);
                        ...
                        else
                        {
                            ...
                            userPosting.Outward = item.betAmount - totalAmount;
            ...
            if (betTeam != 0)
            {
                ...
                if (tempOver == true)
                {
                    if (tempHome == true)
                    {
                        //HomeGoal - AwayGoal
                        diff = h - a;
                        totalAmount = bettingCal.WinOrLoseOver(goalUnitInt, diff, unit, betAmount, (decimal)commission);
                        Console.WriteLine(totalAmount);
                    }
                    else
                    {
                ...
                else
                {
                    if (tempHome == true)
                    {
                        ...
                        diff = a - h;
                        unit *= -1;
                        totalAmount = bettingCal.WinOrLoseUnder(goalUnitInt, diff, unit, betAmount, (decimal)commission);
                        Console.WriteLine(totalAmount);
                            ...
                            if (@item.Overs == false && @item.Under == false)
                            {
                                ...
                                if (tempOver == true)
                                {
                                    if ((bool)@item.IsHome)
                                    {
                                        ...
                                        totalAmount = bettingCal.Mix_WinOrLoseOver(goalUnitInt, diff, unit, @item.Amount);
                                        Console.WriteLine(totalAmount);
                                    }
                                    else
                                    {
                                ...
                                if ((bool)@item.IsHome)
                                {
                                    ...
                                    diff = @item.AwayResult - @item.HomeResult;
                                    unit *= -1;
                                        totalAmount = bettingCal.Mix_WinOrLoseUnder(goalUnitInt, diff, unit, @item.Amount);
                                        Console.WriteLine(totalAmount);
